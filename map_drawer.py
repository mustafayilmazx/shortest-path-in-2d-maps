...
def update_corner_options(*args):
    ...
    corner_list_menu = tk.OptionMenu(control_panel, current_corner, *corner_options)
...
x_entry = tk.Entry(control_panel)
x_entry.pack()
y_entry = tk.Entry(control_panel)
y_entry.pack()

# Koordinatları Güncelleme Butonu
update_button = tk.Button(control_panel, text="Koordinatları Güncelle", command=update_coordinates)
update_button.pack()
...
coord_label = tk.Label(root, text="Koordinatlar: 0, 0")
